package com.msb.monitor.analysis.trafficinterface.process.imple;
...
import com.msb.monitor.analysis.trafficinterface.bean.CustomException;
...
public class DataServiceImpl implements DataService {
    ...
    public void process(String dataType, HttpServletRequest request) throws Exception {
        ...
        System.out.println("====》DataServiceImple: "+jsonStr);
